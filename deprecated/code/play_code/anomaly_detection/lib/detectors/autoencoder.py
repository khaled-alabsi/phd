...
This module implements autoencoder-based anomaly detectors for multivariate anomaly detection.
Includes both a basic autoencoder and an enhanced version with improved architecture.
"""
...
class AutoencoderDetector:
    ...
    Uses a simple autoencoder neural network to learn normal patterns
    ...
    def __init__(self, encoding_dim: int = 8):
        ...
        Args:
            encoding_dim: Dimension of the encoding (bottleneck) layer
        """
...
class AutoencoderDetectorEnhanced:
    """
    Enhanced Autoencoder Anomaly Detector.
    
    Features an improved architecture with:
    - Batch normalization and dropout for regularization
    - Dynamic layer sizing
    - Combined error metrics (MSE + MAE)
    ...
    def __init__(self, encoding_dim: int = 8):
        """
        Initialize the enhanced autoencoder detector.
    ...
    def fit(self, X_train: np.ndarray, epochs: int = 50, batch_size: int = 32, 
            threshold_percentile: float = 95) -> None:
        """
        Train the enhanced autoencoder on normal data.
